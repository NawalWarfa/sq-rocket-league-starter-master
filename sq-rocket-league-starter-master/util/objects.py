...
class GoslingAgent(BaseAgent):
    ...
    def is_in_behind_of_ball(self):
        me_to_ball = (self.ball.location - self.me.location).magnitude()
        me_to_foe = (self.foe_goal.location -self.me.location).magnitude()
        if me_to_ball < me_to_foe + 1000:
            return True
        return False
